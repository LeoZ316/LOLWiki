                        ...
                        <tr className='output-rec0' key={tmp.Champion_ID}>
                            ...
                            <td>
                                <VictoryPie
                                    ...
                                    data={[
                                        { x: Math.round(tmp.Win_Rate), y: Math.round(tmp.Win_Rate) },
                                        { x: 100 - Math.round(tmp.Win_Rate), y: 100 - Math.round(tmp.Win_Rate) }
                                    ]}
                                    width={250}
                                    height={250}
                                    innerRadius={50}
                                /></td>
                            <td className='wins'> Win Rate: {tmp.Win_Rate}% </td>
                        </tr>
                    ))
                    }
                </ table>
